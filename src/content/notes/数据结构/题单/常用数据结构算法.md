> 转自灵神题单：[分享丨【算法题单】常用数据结构（前缀和/栈/队列/堆/字典树/并查集/树状数组/线段树）](https://leetcode.cn/discuss/post/3583665/fen-xiang-gun-ti-dan-chang-yong-shu-ju-j-bvmv/)
...
-  [1895. 最大的幻方](https://leetcode.cn/problems/largest-magic-square/) 1781 斜向前缀和 可以优化到 O(N3)
...
-  [1292. 元素和小于等于阈值的正方形的最大边长](https://leetcode.cn/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold/) 1735 可以优化到 O(mn)
...
附加模板题：[CF1850H](https://leetcode.cn/link/?target=https%3A%2F%2Fcodeforces.com%2Fproblemset%2Fproblem%2F1850%2FH)
...
基础模板代码如下。为方便入门理解，我没有做复杂封装。通用模板代码可以参考 AtCoder Library 的 [segtree.hpp](https://leetcode.cn/link/?target=https%3A%2F%2Fgithub.com%2Fatcoder%2Fac-library%2Fblob%2Fmaster%2Fatcoder%2Fsegtree.hpp)。
...
-  [3777. 使子字符串变交替的最少删除次数](https://leetcode.cn/problems/minimum-deletions-to-make-alternating-substring/) 分治
...
基础模板代码如下。为方便入门理解，我没有做复杂封装。通用模板代码可以参考 AtCoder Library 的 [lazysegtree.hpp](https://leetcode.cn/link/?target=https%3A%2F%2Fgithub.com%2Fatcoder%2Fac-library%2Fblob%2Fmaster%2Fatcoder%2Flazysegtree.hpp)。
...
[ST 表](https://leetcode.cn/link/?target=https%3A%2F%2Foi-wiki.org%2Fds%2Fsparse-table%2F) 支持区间最值查询（Range Minimum/Maximum Query，RMQ），但不支持修改。
